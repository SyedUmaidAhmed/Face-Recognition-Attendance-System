...
def TrainImages():
   ...
   #recognizer = cv2.LBPHFaceRecognizer_create()#$cv2.createLBPHFaceRecognizer()
    ...
    recognizer.write(r"C:\Face-Recognition-Based-Attendance-System-Python-master\TrainingImageLabel\Trainner.yml")
...
def TrackImages():
    ...
    recognizer.read(r"C:\Face-Recognition-Based-Attendance-System-Python-master\TrainingImageLabel\Trainner.yml")
    harcascadePath = "haarcascade_frontalface_default.xml"
...
copyWrite.insert("insert", "Developed by Syed Umaid Ahmed","", "Pi TEAM", "superscript")
